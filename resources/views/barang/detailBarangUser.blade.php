...
<div class="span9">
	...
	<div class="row">	
        ...
        @for($i=1; $i<=sizeof($barang); $i++)  
            <a href="themes/images/products/large/f1.jpg" title="{{ asset('image/'.$images[$i-1]->image_name) }}">
				<img src="{{ asset('image/'.$images[$i-1]->image_name) }}" style="width: 200px;" alt="{{ $barang->product_name }}"/>
            </a>
        @endfor
