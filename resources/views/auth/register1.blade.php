				...
				<div class="col-lg-6">
					<div class="login_form_inner reg_form">
						...
						<form class="row login_form" action="{{ route('register') }}"  method="POST" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
                                <input id="profile_image" type="text" class="form-control{{ $errors->has('profile_image') ? ' is-invalid' : '' }}" name="profile_image" value="{{ old('profile_image') }}" placeholder='Profil Image'  required autofocus>
							</div>
							<div class="col-md-12 form-group">
                                <input id="status" type="text" class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status" value="{{ old('status') }}" placeholder='status' required autofocus>
							</div>
							<div class="col-md-12 form-group">
