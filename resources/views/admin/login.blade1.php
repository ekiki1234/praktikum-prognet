...
<head>
	...
	<title>Fashiop</title>
    <!-- Bootstrap CSS -->
    {{asset('asset/css/plugins/font-awesome.min.css')}}
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
                        ...
                        <form method="POST" action="{{ route('login.admin') }}" class="row login_form" id="contactForm" novalidate="novalidate">
                        @csrf
